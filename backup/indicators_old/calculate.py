...
def add_indicators(df):
   ...
   # =====================
    ...
    df.loc[df["RSI"] > 55, "SWING_SCORE"] += 20
    df.loc[df["Close"] > df["EMA20"], "SWING_SCORE"] += 20
    df.loc[df["EMA20"] > df["EMA50"], "SWING_SCORE"] += 20
    df.loc[df["ADX"] > 20, "SWING_SCORE"] += 20
    df.loc[df["TREND"] == "BULLISH", "SWING_SCORE"] += 20
    ...
    df.loc[df["Close"] > df["EMA200"], "BREAKOUT_SCORE"] += 25
    df.loc[df["RSI"] > 60, "BREAKOUT_SCORE"] += 25
    df.loc[df["Volume"] > df["VOLUME_AVG20"], "BREAKOUT_SCORE"] += 25
    df.loc[df["TREND"] == "BULLISH", "BREAKOUT_SCORE"] += 25
    ...
    df["CPR_TOP"] = ((high + low) / 2)
    df["CPR_BOTTOM"] = (2 * pivot) - df["CPR_TOP"]
